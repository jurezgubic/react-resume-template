  ...
  description: (
    <>
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        I'm a <strong className="text-stone-100">PhD student</strong> working on climate models at the University of
        Cambridge.{' '}
      </p>
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
...
export const aboutData: About = {
  ...
  description: `I studied physics & applied mathematics and began dabbling in climate 
      science in 2021. Currently, I am a PhD student at the University of Cambridge, working on the representation of convective 
      clouds in climate models.
      
      I work part-time as a teacher at Cambridge Spark, where I teach basic data 
...
export const education: TimelineItem[] = [
  {
    ...
    content: (
      <p>A Scottish special: joint degree! Thesis on the percolation characteristics of systems with a barrier.</p>
    ),
  },
  {
    date: 'September 2022',
...
export const experience: TimelineItem[] = [
  {
    ...
    content: (
      <p>
        Teaching and tutoring Excel, Python, data science, and, on rare occasions, machine learning, to company clients-
        catering to a spectrum of learner expertise, ranging from complete beginners to advanced learners.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        Providing conversational AI models with data on climate science by generating questions, evaluating responses
        and collaborating with engineers to improve model effectiveness.
      </p>
    ),
  },
];
  ...
  testimonials: [
    {
      ...
      text: 'Why would anyone play with this much spin on a grass court?!',
    },
    {
      name: 'Grandma',
